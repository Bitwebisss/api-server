(function() {
    ...
    const apiMethods = [
        ...
        { name: 'GET /unspent/<address>', method: 'GET', id: 'unspent', desc: 'UTXO list. Each item includes <code>txid</code>, <code>index</code>, <code>value</code>, <code>height</code>, <code>script</code>, <code>coinbase</code> (bool — true if mined as block reward). Optional <code>?amount=</code> to filter by minimum value (satoshis), <code>?confirmed=true</code> to skip mempool UTXOs.', base: '/unspent/', params: [{ title: 'address', key: true, placeholder: 'web1q... or base58 address' }, { title: 'amount', key: false, placeholder: '0  (min satoshis, optional)' }] },
        ...
        { name: 'GET /history/<address>', method: 'GET', id: 'history', desc: 'Transaction history for address. Each item: <code>{tx_hash, height}</code>. Add <code>?detailed=true</code> to annotate with <code>direction</code> ("in"/"out") and <code>received_sat</code> (last 50 txs). <code>height&nbsp;==&nbsp;0</code> = mempool.', base: '/history/', params: [{ title: 'address', key: true, placeholder: 'web1q... or base58 address' }, { title: 'detailed', key: false, placeholder: 'true  (optional)' }] },
